...
const perks= [
  {
    ...
    description: 'Get your asstes delivered to your mail in seconds and download them right away'
  },
  {
  ...
  },
  {
    name: 'For the Planet',
    icon: Leaf,
    description: "We've Pledged 1% of sales to the preservetion and restoration of natural environment"
  },
]
        ...
        <div className="grid grid-cols-1 gap-y-12 sm:grid-cols-2 sm:gap-x-6 lg:grid-cols-3 lg:gap-x-8 lg:gap-y-8">
          {perks.map((perk)=>(
            <div key={perk.name} className="text-center md:flex md:items-start md:text-left lg:block lg:text-center">
              ...
              <div className="mt-6 md:ml-4 md:mt-0 lg:mt-0 lg:ml-6">
